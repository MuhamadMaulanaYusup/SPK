    ...
    <div class="panel panel-flat">
        ...
        <form action="<?php echo e(url('admin/soal/edit',$soal->id_soal)); ?>" method="POST" class="form-horizontal"
            ...
            <div class="panel-body">
                ...
                <textarea class="summernote" name="pertanyaan"><?php echo e($soal->pertanyaan); ?>
                    ...
                    <div class="col-md-10">
                        ...
                        <label class="radio-inline">
                            <input type="radio" name="kunci" class="styled"
                                <?php echo e($soal->kunci == "A" ? 'checked="checked' : ""); ?> checked="checked" value="A">
                            Jawaban <b>A</b>
                        </label>

                        <label class="radio-inline">
                            <input type="radio" name="kunci" class="styled" value="B"
                                <?php echo e($soal->kunci == "B" ? 'checked="checked' : ""); ?>>
                            Jawaban <b>B</b>
                        </label>

                        <label class="radio-inline">
                            <input type="radio" name="kunci" class="styled" value="C"
                                <?php echo e($soal->kunci == "C" ? 'checked="checked' : ""); ?>>
                            Jawaban <b>C</b>
                        </label>

                        <label class="radio-inline">
                            <input type="radio" name="kunci" class="styled" value="D"
                                <?php echo e($soal->kunci == "D" ? 'checked="checked' : ""); ?>>
                            Jawaban <b>D</b>
                        </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input type="number" class="form-control" name="score" min="0" value="<?php echo e($soal->score); ?>"
                            required>
...
<?php echo $__env->make('layouts.dashboardMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Program Proyek Akhir\SPK\resources\views/admin/soal/edit.blade.php ENDPATH**/ ?>