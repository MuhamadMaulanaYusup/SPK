...
<div class="panel panel-flat">
    <div class="panel-heading">
        <a href="<?php echo e(url('admin/lowongan/create')); ?>" class="btn btn-primary"> <i class="icon-plus3"></i> Tambah Lowongan</a>
...
<script>
    $(document).ready(function() {
        ...
        table = $('#lowongan').DataTable({
            ...
            ajax: '<?php echo e(url('admin/lowongan')); ?>',
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
...
<?php echo $__env->make('layouts.dashboardMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Program Proyek Akhir\SPK\resources\views/admin/lowongan/index.blade.php ENDPATH**/ ?>