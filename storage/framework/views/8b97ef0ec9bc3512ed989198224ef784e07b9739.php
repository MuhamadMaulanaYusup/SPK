...
<script type="text/javascript"
    src="<?php echo e(asset('template/material/assets/js/plugins/tables/datatables/datatables.min.js')); ?>"></script>
...
<div class="panel panel-flat">
    <div class="panel-heading">
        <a href="<?php echo e(url('admin/soal/create')); ?>" class="btn btn-primary"> <i class="icon-plus3"></i> Tambah Soal</a>
...
<script>
    $(document).ready(function () {
        ...
        table = $('#soal').DataTable({
            ...
            ajax: '<?php echo e(url("admin/soal")); ?>',
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
...
<?php echo $__env->make('layouts.dashboardMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Program Proyek Akhir\SPK\resources\views/admin/soal/index.blade.php ENDPATH**/ ?>