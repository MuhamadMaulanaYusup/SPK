    ...
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                ...
                <span class="text-semibold">Admin</span> - Edit Lowongan
            </h4>
        </div>
    ...
    <div class="col-md-12">
        <div class="panel panel-flat border-top-teal">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="<?php echo e(url('admin/lowongan/edit',$lowongan->id_lowongan)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control text-uppercase" name="posisi" required placeholder="Masukkan Posisi Lowongan" value="<?php echo e($lowongan->posisi); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="tgl_lahir" placeholder="Masukkan Tanggal Selesai" name="tanggal_selesai" value="<?php echo e($lowongan->tanggal_selesai); ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="tgl_lahir" placeholder="Masukkan Keterangan Lowongan" name="keterangan" value="<?php echo e($lowongan->keterangan); ?>">
                          ...
                          <table class="table">
                            ...
                            <tbody>
                              <?php $__currentLoopData = $syarat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                  <td><input type="text" class="form-control text-uppercase" name="syarat[]" placeholder="Masukkan Syarat Lowongan" required value="<?php echo e($value->nama_syarat); ?>"></td>
                                ...
                                <?php else: ?>
                                  <tr id="row<?php echo e($key); ?>">
                                    <td><input type="text" class="form-control text-uppercase" name="syarat[]" placeholder="Masukkan Syarat Lowongan"  value="<?php echo e($value->nama_syarat); ?>"required></td>
                                    <td><button type="button" class="text-right btn btn-danger btn-icon btn-rounded btn_remove legitRipple" id="<?php echo e($key); ?>" name="remove">
                                  <i class="icon-minus2"></i></button></td>
                                  </tr>
                              <?php endif; ?>
...
<?php echo $__env->make('layouts.dashboardMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Program Proyek Akhir\SPK\resources\views/admin/lowongan/edit.blade.php ENDPATH**/ ?>