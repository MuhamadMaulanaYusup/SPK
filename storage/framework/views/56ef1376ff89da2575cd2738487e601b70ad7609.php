          ...
          <div class="panel" style="overflow-y: scroll;">
              <div class="panel-header">
                  <h3 class="box-title">
                      Soal No:
                      <?php if($soals->count()): ?>
                      <?php $__currentLoopData = $soals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_number=>$data_number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($key_number == 0): ?> <span id="no_soal_detail">1</span> <?php endif; ?>
              ...
              <div class="panel-body">
                  <div id="wrap-soal">
                      <?php if($soals->count()): ?>
                      <?php $__currentLoopData = $soals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($key == 0): ?>
                      ...
                      <?php echo $data->pilb ? '<div class="jawab" soal-id="'.$data->id_soal.'" data-id="'.$data->id_soal.'"
                      ...
                      <?php echo $data->pild ? '<div class="jawab" soal-id="'.$data->id_soal.'" data-id="'.$data->id_soal.'"
              ...
              <div class="box-body">
                  ...
                  <nav aria-label="Page navigation">
                      <ul class="pagination" style="margin-top: 5px !important;">
                          <?php $__currentLoopData = $soals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key_number=>$data_number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <li class="no_soal" id="<?php echo e('nav'.$data_number->id_soal); ?>"
                              data-id="<?php echo e($data_number->id_soal); ?>" data-no="<?php echo e($key_number+1); ?>"><a
                                  href="#"><?php echo e($key_number+1); ?></a></li>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </ul>
                  </nav>
                  <?php endif; ?>
  ...
  <script src="<?php echo e(url('js/jquery.fullscreen-min.js')); ?>">
  ...
  <script>
      ...
      $(document).ready(function () {
          ...
          $('.no_soal').click(function () {
              ...
              $.ajax({
                  type: "GET",
                  url: "<?php echo e(url('soal/')); ?>/" + id_soal,
          ...
          $(document).on('click', ".jawab", function () {
              ...
              $.ajax({
                  type: "POST",
                  url: "<?php echo e(url('soal/jawabs')); ?>",
                  data: {
                      get_jawab: get_jawab
                  },
                  success: function (data) {
...
<?php /**PATH D:\Program Proyek Akhir\SPK\resources\views/user/form/soal.blade.php ENDPATH**/ ?>